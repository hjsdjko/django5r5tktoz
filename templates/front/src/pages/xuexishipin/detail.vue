...
<div>
	...
	<div class="detail-preview" :style='{"padding":"40px calc((100% - 1200px)/2)","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"minHeight":"340px","padding":"0px","margin":"0","flexWrap":"wrap","background":"none","display":"block","width":"100%","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>视频类型</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.shipinleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>视频介绍</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.shipinjieshao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>发布日期</div>
				...
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#009cf5","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('xuexishipin','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('xuexishipin','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('xuexishipin','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
		...
		<video :style='{"border":"0","minHeight":"300px","margin":"30px 0 20px 7%","borderRadius":"0","maxHeight":"370px","display":"block","width":"30%","order":"90"}' :src="baseUrl +  detail.shipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
    ...
    methods: {
      ...
      nextClick(page) {
		...
		backClick(){
			...
			this.$router.push({path: '/index/xuexishipin', query: params});
		},
		// 下载
		download(file){
			if(!file) {
	  ...
	  addDiscussNum(type){
		...
		// 删除
		async delClick(){
			await this.$confirm('是否删除此学习视频？')
			  .then(_ => {
			    this.$http.post('xuexishipin/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
