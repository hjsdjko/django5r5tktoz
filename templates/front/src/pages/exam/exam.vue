<template>
  <div>
    <div class="top-content">
      ...
      <div class="top-content-center" v-cloak>距离测试结束还有 <el-tag type="danger">{{this.hour}}</el-tag> 时 <el-tag type="danger">{{this.minute}}</el-tag> 分 <el-tag type="danger">{{this.second}}</el-tag> 秒</div>
    ...
    <div class="question-content" v-for="(item, index) in questionList" :key="item.id" v-if="curQuesIndex == index">
      <div class="question-title" v-if="!end">
        题目 ({{item.score}}分)：{{item.questionname}}
      ...
      <div class="question-answer">
        ...
        <div v-if="end">
          <div class="question-title">测试成绩：<el-tag type="danger">{{totalScore}}</el-tag> 分</div>
        </div>
      </div>
      <div class="question-btn">
        ...
        <el-button v-if="end" type="success" @click="doneExam(1)">结束测试</el-button>
      </div>
    </div>
	</div>
</template>
