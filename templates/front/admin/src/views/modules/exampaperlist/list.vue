        ...
        >
          ...
          >
            <template slot-scope="scope">
			  <el-button class="view" :style='{"border":"0","cursor":"pointer","padding":"0 6px 0 4px","margin":"0 4px 4px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgb(92, 229, 251)","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
