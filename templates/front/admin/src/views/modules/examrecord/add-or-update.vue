<template>
  <div class="main-content" :style='{"padding":"30px"}'>
    <!-- 列表页 -->
    <div v-if="!showFlag">
      <el-form :style='{"padding":"40px 30px","boxShadow":"0 1px 6px rgba(64, 158, 255, .3)","borderRadius":"6px","flexWrap":"wrap","background":"#fff","display":"flex"}' :inline="true" :model="searchForm" class="add-update-preview">
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="在线测试">
          <el-input v-model="searchForm.papername" placeholder="在线测试名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="试题">
