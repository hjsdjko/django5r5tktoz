  ...
  <div class="main-content" :style='{"padding":"30px"}'>
	...
	<div :style='{"width":"100%","padding":"0","overflow":"hidden","borderRadius":"8px"}'>
        ...
        >
          ...
          >
            <template slot-scope="scope">
			  <el-button class="view" :style='{"border":"0","cursor":"pointer","padding":"0 6px 0 4px","margin":"0 4px 4px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgb(92, 229, 251)","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row)">
			  	<span class="icon iconfont icon-chakan2" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			  	查看
			  </el-button>
			  <el-button class="del" :style='{"border":"0","cursor":"pointer","padding":"0 6px 0 4px","margin":"0 4px 4px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#D32F2F","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('examrecord','删除')" type="success" @click="deleteHandler(scope.row)">
			  	<span class="icon iconfont icon-shanchu8" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			  	删除
			  </el-button>
			  <el-button class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 6px 0 4px","margin":"0 4px 4px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#008CBA","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('examrecord','批卷')&&scope.row.ismark>0" type="primary" @click="gradeClick(scope.row)">
