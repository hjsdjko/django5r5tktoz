<template>
  <div :style='{"padding":"30px"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="选择在线测试" prop="paperid">
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="类型" prop="type">
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="ruleForm.type!=3&&ruleForm.type!=2&&ruleForm.type!=4" label="选项" prop="options">
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
        <el-select v-model="ruleForm.answer" @change="answerChange">
          <el-option
            :label="item.text"
            :value="item.code"
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="ruleForm.type==3" label="答案" prop="answer">
        <el-input v-model="ruleForm.answer" placeholder="答案" clearable @input="answerChange"></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="分数" prop="score">
        <el-input-number v-model="ruleForm.score" :min="1" :max="100" label="分数"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="分析" prop="analysis">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="排序" prop="sequence">
      ...
      <el-form-item :style='{"width":"100%","padding":"0","margin":"20px 0 0"}'>
		<el-button class="btn3" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#1DD9F8","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="onSubmit">
			<span class="icon iconfont " :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			提交
		</el-button>
		<el-button class="btn4" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#1DD9F8","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="back()">
			<span class="icon iconfont " :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			取消
		</el-button>
      </el-form-item>
